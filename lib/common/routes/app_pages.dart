...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      ...
      page: () => Builder(builder: (context) => const IntroductionScreenPage()),
      binding: IntroScreenBinding(),
    ),
    GetPage(
      name: _Paths.chooseLoginOption,
      page: () => Builder(builder: (context) => LoginOptionsScreen()),
      binding: LoginOptionBinding(),
    ),
    GetPage(
      name: _Paths.loginWithOtpScreen,
      page: () => Builder(builder: (context) => OtpLoginScreen()),
