...
// export 'package:carousel_slider/carousel_slider.dart' ;z
...
///intro screen
export 'package:videocalling_medical/common/screens/intro_screen.dart';
export 'package:videocalling_medical/common/controllers/intro_screen_controller.dart';
export 'package:videocalling_medical/common/bindings/intro_screen_binding.dart';

///choose login option
export 'package:videocalling_medical/common/screens/choose_login_option_screen.dart';
export 'package:videocalling_medical/common/controllers/choose_login_option_controller.dart';
export 'package:videocalling_medical/common/bindings/choose_login_option_binding.dart';

/// Otp Login
export 'package:videocalling_medical/common/screens/login_with_otp_screen.dart';
export 'package:videocalling_medical/common/controllers/login_with_otp_controller.dart';
export 'package:videocalling_medical/common/bindings/login_with_otp_binding.dart';
