...
class DoctorDetailScreen extends GetView<DoctorDetailController> {
  ...
  /// 1== doctor, 2== pharmacy 3==laboratory
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        flexibleSpace: CustomAppBar(
          title: detailController.page == 1
              ? 'doctor_detail'.tr
              : detailController.page == 2
              ? 'pharmacy_detail'.tr
              : 'laboratory_detail'.tr,
          isBackArrow: true,
          onPressed: () => Get.back(),
        ),
        leading: Container(),
                              ...
                              ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl: detailController
                                      ...
                                      ?.image ??
                                      '',
                                  height: detailController.page == 1
                                      ? 80
                                      : 90,
                                  width: detailController.page == 1
                                      ? 80
                                      : 90,
                                  fit: BoxFit.cover,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (detailController.page != 1) 4.hs,
                              if (detailController.page != 1)
                                Divider(
                                    thickness: 1,
                                    color: AppColors.greyShade3),
                              if (detailController.page != 1) 2.hs,
