    ...
    return Scaffold(
      ...
      appBar: AppBar(
        flexibleSpace: CustomAppBar(
          title: detailsController.isPharmacy.value == doctorKey
              ? 'appointment'.tr
              : detailsController.isPharmacy.value == pharmacyKey
              ? 'order'.tr
              : 'report'.tr,
          isBackArrow: true,
          onPressed: () => Get.back(),
      ...
      body: Obx(
        ...
        detailsController.isLoaded.value
          ...
          child: ListView.builder(
              ...
              if (1 == index) {
                ...
                return Column(
                  ...
                  children: [
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                detailsController
                                                    ...
                                                    ? 'order_status_2'
                                                    .tr
                                                    : detailsController.dataList.data!.status!! == 3
                                                    ? 'order_status_3'.tr
                                                    : detailsController.dataList.data!.status! == 4
                                                    ? 'order_status_4'.tr
                                                    : detailsController.dataList.data!.status! == 5
                                                    ? 'order_status_5'.tr
                    ...
                    if (detailsController.isprescription.value ==
                        false)
                      Padding(
            ...
            : Container()
            : detailsController.isPharmacy.value == labKey
            ?
                ...
                children: [
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          detailsController.reportDataList
                              .data!.laboratoryImage
                              .toString() !=
                              ""
                              ? SizedBox(
                            height: 70,
                                            ...
                                            Obx(() {
                                              return Text(
                                                detailsController
                                                    ...
                                                    ? 'order_status_0'
                                                    .tr //Received
                                                    : detailsController.apOrderStatus.value ==
                                                    1
                                                    ? 'order_status_1'
                                                    .tr //Accept
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              AppTextWidgets
                                                  .regularText(
                                                text:
                                                "${detailsController.reportDataList.data!.report![index2].price.toStringAsFixed(1) ?? ""}$CURRENCY",
                                                color:
                                                AppColors
                                                    .BLACK,
                                                size: 14,
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Spacer(),
                              Text(
                                '${detailsController.reportDataList.data!.subtotal}$CURRENCY',
                                maxLines: 2,
                                style: TextStyle(
                                  fontFamily:
                                  AppFontStyleTextStrings
                          ...
                          5.hs,
                          if (detailsController.reportDataList
                              .data!.address!
                              .toString() !=
                              "Lab Visit".tr)
                            Row(
                  ...
                  Obx(() {
                    return Container(
                      child:
                      (detailsController.apOrderStatus
                          .value ==
                          0 ||
                          detailsController
                              .apOrderStatus
                                  ...
                                  children: [
                                    Expanded(
                                      child: InkWell(
                                          onTap: () async {
                                            detailsController
                                                .changeReportStatus(7)
                                                .then(
                                                  (value) {
                                                detailsController.fetchReportDetails();
