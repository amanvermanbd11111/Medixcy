...
import '../../main.dart';
import '../screens/pharmacy_add_medicine_screen.dart';
  ...
  callNotification() async {
    ...
    FirebaseMessaging.onMessage.listen((message) {
      ...
      if ((message.data['signal_type'] != null) &&
        ...
        } catch (e) {print("error on catch :::: $e");}
  ...
  getPagePharmacy(int page) {
    switch (page) {
      ...
      case 2:
        return DoctorProfile();
      case 3:
        return PharmacyAddMedicineScreen();
        case 4:
        return MoreInfoScreen();
    }
  }
  getPageLaboratory(int page) {
    switch (page) {
      case 0:
        return DoctorDashboard();
      case 1:
