...
?      Padding(
  ...
  Widget buttonForReport({required BuildContext context, required bool isHome}) {
    ...
    return Align(
      ...
      child: Obx(() => (apOrderStatus.value == 0)
        ...
        child: Row(
          ...
          :  apOrderStatus.value == 5
          ? Column(
        mainAxisAlignment: MainAxisAlignment.end,
        children: [
          CustomButton(
            onTap: () {
              changeReportStatus(3);
            },
            btnText: 'Complete'.tr,
            margin: const EdgeInsets.fromLTRB(20, 0, 20, 5),
  ...
  changeReportStatus(status) async {
    ...
    if (response.statusCode == 200) {
      ...
      if (jsonResponse['status'].toString() == "1") {
        ...
        // appointmentsController.fetchPastReport()
