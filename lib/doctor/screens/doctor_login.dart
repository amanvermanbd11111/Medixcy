...
class LoginAsDoctor extends GetView<DoctorLoginController> {
  ...
  List departmentList = ['login_as_doctor'.tr, 'login_as_pharmacy'.tr, 'login_as_laboratory'.tr];
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Obx(() {
                          return Image.asset(
                            doctorLoginController.selectedValue.value.toString() ==
                                'login_as_doctor'.tr
                          ...
                          child: InkWell(
                            onTap: () {
                              ...
                              doctorLoginController.selectedValue.value.toString() ==
                                  ...
                                  : doctorLoginController.selectedValue.value.toString() ==
                                  'login_as_pharmacy'.tr
                                  ? doctorLoginController.loginIntopharmacy()
                                  : doctorLoginController.selectedValue.value.toString() ==
                                  'login_as_laboratory'.tr
                                  ? doctorLoginController.loginIntoLaboratory()
                                  : doctorLoginController.loginInto();
                            },
                            child: Stack(
                              children: [
                                ...
                                Obx(() {
                                  return Center(
                                    child: AppTextWidgets.mediumText(
                                      text: doctorLoginController.selectedValue.value.toString() ==
                                          'login_as_doctor'.tr
                                          ? 'login_as_doctor'.tr
                                          : doctorLoginController.selectedValue.value.toString() ==
                                          'login_as_laboratory'.tr
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    Get.toNamed(Routes.doctorRegisterScreen, arguments: {
