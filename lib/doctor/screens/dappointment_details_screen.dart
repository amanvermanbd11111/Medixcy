...
import '../../services/send_chat_notification_service.dart';
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          flexibleSpace: CustomAppBar(
            title: detailsController.loginKey.value == pharmacyKey
                ? 'order_str'.tr
                : detailsController.loginKey.value == labKey
                ? 'report'.tr
                : 'appointment'.tr,
            isBackArrow: true,
            onPressed: () =>
            ...
            children: [
              Column(
                children: [
                  Expanded(
                    child:
                    detailsController.loginKey.value ==
                        pharmacyKey
                                              ...
                                              Container(
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    AppTextWidgets
                                                        .semiBoldText(
                                                      text: detailsController.orderDetail.data!.userName.toString() ??
                                                          "",
                                                      color:
                                                      AppColors.BLACK,
                                                      size:
                                                    ...
                                                    Container(
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            detailsController.orderDetail.data!.status! == 0
                                                                ? 'order_status_0'.tr
                                                                : detailsController.orderDetail.data!.status! == 1
                                                                ? 'order_status_1'.tr
                                          ...
                                          itemBuilder:
                                            ...
                                            return Row(
                                              ...
                                              MainAxisAlignment
                                                  .spaceBetween,
                                              children: [
                                                detailsController.orderDetail.data!.medicine![index2].medicineImg.toString() !=
                                                    ""
                                                    ? Container(
                                                  height: 70,
                                                  width: 70,
                                                  child: ClipRRect(
                                                    ...
                                                    child: CachedNetworkImage(
                                                      imageUrl: detailsController.orderDetail.data!.medicine![index2].medicineImg.toString(),
                                                      fit: BoxFit.cover,
                                                    ...
                                                    children: [
                                                        ...
                                                        children: [
                                                          Expanded(
                                                            child: Text(
                                                              ...
                                                              maxLines: 2,
                                                              style: const TextStyle(fontFamily: AppFontStyleTextStrings.regular, fontSize: 14, color: AppColors.BLACK),
                                                      ...
                                                      Row(
                                                        children: [
                                                          ...
                                                          AppTextWidgets.regularText(
                                                            text: '${detailsController.orderDetail.data!.medicine![index2].qty.toString() ?? ""}',
                                                            color: AppColors.BLACK,
                                                            size: 14,
                                                          ),
                                                          const SizedBox(
                                                          ...
                                                          AppTextWidgets.regularText(
                                                            text: "${detailsController.orderDetail.data!.medicine![index2].price.toStringAsFixed(1) ?? ""}$CURRENCY",
                                                            color: AppColors.BLACK,
                                                            size: 14,
                                                          ),
                                                        ],
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                // delivery_charge
                                                detailsController.orderDetail.data!.deliveryCharge !=
                                                    null
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Spacer(),
                                              Text(
                                                detailsController.orderDetail.data!.taxPr !=
                                                    null
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Spacer(),
                                                detailsController.orderDetail.data!.prescriptionPrice !=
                                                    null
                                                    ? Text(
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  AppTextWidgets
                                                      .semiBoldText(
                                                    text:
                                                    detailsController.reportDataList.data!.userName.toString() ?? "",
                                                    color:
                                                    AppColors.BLACK,
                                                    size:
                                                    13,
                                                  ...
                                                  2.hs,
                                                  Text(
                                                    detailsController.reportDataList.data!.phone.toString(),
                                                    style: Theme.of(context).textTheme.bodySmall!.apply(
                                                      fontWeightDelta: 2,
                                                      color: Theme.of(context).primaryColorDark.withOpacity(0.5),
                                                    ),
                                                  ...
                                                  Container(
                                                    ...
                                                    decoration:
                                                    BoxDecoration(borderRadius: BorderRadius.circular(15), color: Theme.of(context).primaryColorLight),
                                                    child:
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Obx(() {
                                                          return Text(
                                                            detailsController.apOrderStatus.value == 0
                                                                ? 'order_status_0'.tr //Received
                                                                : detailsController.apOrderStatus.value == 1
                                                                ? 'order_status_1'.tr //Accept
                                                                : detailsController.apOrderStatus.value == 2
                                                                ? 'order_status_2'.tr //Reject
                                                                : detailsController.apOrderStatus.value == 3
                                                                ? 'order_status_3'.tr //Completed
                                                                : detailsController.apOrderStatus.value == 4
                                                                ? 'order_status_4'.tr //In Process
                                                                : detailsController.apOrderStatus.value == 5
                                                                ? 'Sample Collected'.tr //Waiting
                                                                : detailsController.apOrderStatus.value == 6
                                                                ? 'absent'.tr // Cancel
                                                                : detailsController.apOrderStatus.value == 7
                                                                ? 'Cancel By User'.tr // Prepared
                                                                : "",
                                                            style: Theme.of(context).textTheme.bodySmall!.apply(
                                                              fontSizeDelta: 0.5,
                                                              fontWeightDelta: 2,
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          AppTextWidgets
                                              .regularText(
                                            text:
                                            "${detailsController.reportDataList.data!.createdAt?.substring(8, 10)}"
                                                "${detailsController.reportDataList.data!.createdAt?.substring(4, 8)}"
                                                "${detailsController.reportDataList.data!.createdAt?.substring(0, 4)}",
                                            color: AppColors
                                                .LIGHT_GREY_TEXT,
                                            size: 11,
                                          ),
                                          Row(
                                            children: [
                                              AppTextWidgets
                                                  .regularText(
                                                text:
                                                "${detailsController.reportDataList.data!.createdAt?.substring(11, 16)}",
                                                color: AppColors
                                                    .BLACK,
                                                size:
                                                15,
                                      ...
                                      children: [
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                detailsController.reportDataList.data!.address!.toString() ==
                                                    "Lab Visit".tr
                                                    ? 'Laboratory Address'.tr
                                              ...
                                              Text(
                                                detailsController.reportDataList.data!.address!.toString() ==
                                                    "Lab Visit".tr
                                                    ? detailsController.reportDataList.data!.laboratoryAddress!.toString()
                                                    : detailsController.reportDataList.data!.address!.toString(),
                                                style: Theme.of(context)
                                                    .textTheme
                                                    .bodySmall!
                                                ...
                                                children: [
                                                  Row(
                                                    ...
                                                    children: [
                                                      Expanded(
                                                        child: Text(
                                                          "${detailsController.reportDataList.data!.report![index2].name.toString()}",
                                                          maxLines: 2,
                                                          style: const TextStyle(fontFamily: AppFontStyleTextStrings.regular, fontSize: 14, color: AppColors.BLACK),
                                                          overflow: TextOverflow.ellipsis,
                                                        ),
                                                      ...
                                                      Row(
                                                        children: [
                                                          ...
                                                          AppTextWidgets.regularText(
                                                            text: "${detailsController.reportDataList.data!.report![index2].price.toStringAsFixed(1) ?? ""}$CURRENCY",
                                                            color: AppColors.BLACK,
                                                            size: 14,
                                                          ),
                                                        ],
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Spacer(),
                                          Text(
                                            '${detailsController.reportDataList.data!.subtotal.toStringAsFixed(1) ?? ""}$CURRENCY',
                                            maxLines: 1,
                                            style:
                                            TextStyle(
                                              fontFamily:
                                      ...
                                      if (detailsController
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              // delivery_charge
                                              detailsController.reportDataList.data!.deliveryCharge !=
                                                  null
                                                  ? '+${detailsController.reportDataList.data!.deliveryCharge.toStringAsFixed(1)}$CURRENCY'
                                                  : "+0.0$CURRENCY",
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Spacer(),
                                          Text(
                                            detailsController.reportDataList.data!.taxPr !=
                                                null
                                                ? '+${detailsController.reportDataList.data!.taxPr.toStringAsFixed(1)}%'
                                                : "+0.0%",
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Spacer(),
                                          Text(
                                            '${detailsController.reportDataList.data!.total}$CURRENCY',
                                            style:
                                            TextStyle(
                                              fontFamily:
                                              AppFontStyleTextStrings
