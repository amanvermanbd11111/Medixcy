...
class DoctorChooseYourPlanScreen extends GetView<DoctorChooseYourPlanController> {
              ...
              children: [
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: CachedNetworkImage(
                              imageUrl: choosePlanController.doctorImageUrl.value,
                              height: 100,
                              width: 100,
                              fit: BoxFit.cover,
                          ...
                          Text(
                            ...
                            style: Theme.of(context)
                                .textTheme
                                .titleMedium!
                                .apply(fontSizeFactor: 1.2, color: AppColors.LIGHT_BLACK_TEXT),
                          ),
                        ],
                      ),
                    ),
                          ...
                          return Container(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (ctx, index) {
                                ...
                                choosePlanController.price.value = choosePlanController
                                    .getSubscriptionPlanClass!.data!.data![index].price!;
                                return GestureDetector(
                                  onTap: () {
                                    choosePlanController.selectedIndex.value = index;
                                    choosePlanController.selectedAmount1.value =
                                        choosePlanController
                                            .getSubscriptionPlanClass!.data!.data![index].price!;

                                    choosePlanController.selectedSubId.value = data.id ?? 0;
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      ...
                                      Obx(() => AnimatedSwitcher(
                                            duration: const Duration(milliseconds: 500),
                                            child: choosePlanController.selectedIndex.value == index
                                                ? Container(
                                                    margin: const EdgeInsets.only(left: 20),
                                                    decoration: const BoxDecoration(
                                                        gradient: LinearGradient(
                                                          colors: [
                                                            AppColors.checkColor1,
                                                            AppColors.checkColor2,
                                                          ],
                                                          begin: Alignment.topCenter,
                                                          end: Alignment.bottomCenter,
                                                        ),
                ...
                Container(
                  ...
                  child: Text(
                    'choose_plan_des'.tr,
                    style: Theme.of(context).textTheme.titleMedium!.apply(
                        color: AppColors.LIGHT_BLACK_TEXT, fontSizeFactor: 0.8, fontWeightDelta: 0),
                  ),
                ),
                const SizedBox(
                  height: 20,
                ...
                GestureDetector(
                  onTap: () {
                    choosePlanController.bottomSheet(
                        choosePlanController.getSubscriptionPlanClass!.data!.currency,
                        choosePlanController.selectedAmount1.value,
