    ...
    return Scaffold(
      appBar: AppBar(
        flexibleSpace: CustomAppBar(
          title: registerController.isPharmacy.value == doctorKey
              ? 'doctor_register'.tr
              :
          registerController.isPharmacy.value == pharmacyKey
              ?"pharmacy_register".tr
              :    registerController.isPharmacy.value == labKey
              ?"lab_register".tr
              :
          'doctor_register'.tr,
          isBackArrow: true,
                              ...
                              child: InkWell(
                                onTap: () {
                                  ...
                                  if (registerController.formKey.currentState!.validate()) {
                                    registerController.isPharmacy.value == doctorKey
                                    ...
                                    registerController.isPharmacy.value == pharmacyKey
                                        ...
                                        :
                                    registerController.isPharmacy.value == labKey
                                        ? registerController.registerUserLaboratory()
                                        :
                                    registerController.registerUser();
                                  }
                                },
