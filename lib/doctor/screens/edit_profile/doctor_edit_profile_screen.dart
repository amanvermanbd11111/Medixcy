      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          flexibleSpace: Obx(
              ...
              title: profileController.loginKey.value == pharmacyKey
                  ? 'pharmacy_dashboard'.tr
                  : profileController.loginKey.value == labKey
                ...
                Container(
                  ...
                  child: Obx(() => Row(
                    children: [
                      ...
                      if (profileController.loginKey.value == doctorKey)
                        Expanded(
                          child: AnimatedContainer(
                            duration: const Duration(milliseconds: 400),
                            height: 6,
                ...
                Expanded(
                  child: Obx(
                      ...
                      child: Center(
                        ...
                        : profileController.loginKey.value != doctorKey
                        ? profileController.isProfileLoaded.value
                        ? profileController.loginKey.value ==
                        pharmacyKey
                        ? Container(
                      child: Expanded(
                        child: Obx(() => Stack(
                      ...
                      onTap: () {
                        ...
                        if (profileController.index.value == 0) {
                          if ((profileController.doctorProfileDetails?.data
                              ?.image ==
                              "profile.png" ||
                              profileController.doctorProfileDetails
                                  ?.data?.image ==
                                  "user.png") &&
                            ...
                            profileController.isPhoneError.value = true;
                              ...
                              .selectedValue.value ==
                              null) {
                            profileController.isDepartmentError.value =
                            true;
                          } else if (profileController
                              .worktimeController.text.isEmpty) {
                            profileController.isWorkingTimeError.value =
                            true;
                          } else if (profileController
                            ...
                            profileController.isHealthCareError.value =
                            true;
                          } else {
                          ...
                          } else if (profileController.profile.toString() ==
                              "0" ||
                              profileController.profile.toString() ==
                                  null) {
                    ...
                    child: Obx(() => InkWell(
                      onTap: () {
                        ...
                        if (profileController.index.value == 0) {
                          ...
                          else if(profileController.loginKey.value == labKey){

                            if (profileController
                                .homeVisitController.text.isEmpty) {
                              profileController.isHomeVisitError.value = true;
                            }else if (profileController
                                .labVisitController.text.isEmpty) {
                              profileController.isLabVisitError.value = true;
                            }else {
                              profileController.index.value =
                                  profileController.index.value + 1;
                            }
                          ...
                          if (profileController
                            ...
                            FocusScope.of(context).unfocus();
                            if (profileController.loginKey.value ==
                                pharmacyKey) {
                              profileController.uploadPharmacyData();
                            } else {
                              profileController.uploadLaboratoryData();
                            }
                          }
                        }
                      },
