...
class DoctorTabsScreen extends GetView<DoctorTabController> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        body:
        tabController.isPharmacy.value == pharmacyKey
            ?Obx(() => tabController.getPagePharmacy(tabController.index.value))
            :
        tabController.isPharmacy.value == labKey
            ?Obx(() => tabController.getPageLaboratory(tabController.index.value))
          ...
          child: ClipRRect(
            ...
            child: BottomNavigationBar(
              items: [
                ...
                if(controller.isPharmacy.value == doctorKey)
                  BottomNavigationBarItem(
                    icon: Image.asset(
                ...
                if(controller.isPharmacy.value == pharmacyKey)
                  BottomNavigationBarItem(
                    icon: Image.asset(
                      tabController.index.value == 3
                          ? AppImages.tab4Select
                ...
                if(controller.isPharmacy.value == labKey)
                  BottomNavigationBarItem(
                    icon: Image.asset(
                      tabController.index.value == 3
                          ? AppImages.tab4Select
