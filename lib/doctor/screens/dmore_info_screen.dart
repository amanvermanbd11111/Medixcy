    ...
    return Scaffold(
      ...
      body: Column(
        children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Container(
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  if(infoController.loginKey.value == doctorKey)
                                    Text(
                                      (infoController
                                          .doctorProfileWithRating
                                          ?.data
                                  ...
                                  SizedBox(
                                    width: infoController.loginKey.value == doctorKey ? 10 : 0,
                                  ),
                        ...
                        SizedBox(
                          height: infoController.loginKey.value == doctorKey ?10 :0,
                        ),
                        Text(
                          infoController.doctorProfileWithRating
                              ?.data?.address ??
          ...
          if(infoController.loginKey.value == pharmacyKey)
            Expanded(
              child: ListView.separated(
                separatorBuilder: (context, index) => const SizedBox(
                  height: 15,
          ...
          if(infoController.loginKey.value == labKey)
            Expanded(
              child: ListView.separated(
                separatorBuilder: (context, index) => const SizedBox(
                  height: 15,
                ...
                itemCount: infoController.optionList3.length,
              ),
            ),
