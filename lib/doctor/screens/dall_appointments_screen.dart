    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        flexibleSpace: CustomAppBar(
          onPressed: () => Get.back(),
          isBackArrow: true,
          title: appointmentsController.loginKey.value == pharmacyKey
              ? 'all_orders'.tr
              : appointmentsController.loginKey.value == labKey
              ? "all_reports".tr
              : 'all_appointment'.tr,
        ...
        child: Obx(() => Container(
          ...
          child: Column(
            ...
            children: [
              ...
              appointmentsController.loginKey.value == pharmacyKey
                ...
                child: Center(
                  ...
                  ? appointmentsController.isOrderAvailable.value ==
                  true
                  ? ListView.builder(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            ...
                                            index]
                                                ...
                                                ? 'order_status_0'
                                                .tr
                                                : appointmentsController.pharmacyorderdetail!.data![index].status! ==
                                                1
                                                ? 'order_status_1'
                                                .tr
              ...
              /// is laboratory order detail
                  : appointmentsController.loginKey.value == labKey
                  ? Obx(() => appointmentsController
              ...
              if (appointmentsController.loginKey.value == doctorKey)
